...
import { CheckIcon, ChevronDownIcon, ViewIcon, WarningTwoIcon } from "@chakra-ui/icons";
          ...
          <SimpleGrid columns={{ base: 1, md: 2 }} spacing={10}>
            <Stack spacing={4}>
              ...
              <Text color={"gray.500"} fontSize={"lg"}>
                SocialSphere is a network of communities that are created, run,
                and populated the users.Through these communities, you can post,
                comment, vote, discuss, learn, debate, support, and connect with
                people who share your interests, and we encourage you to find—or
                even create—your home on this platform.While not every community
                may be for you (and you may find some unrelatable or even
                offensive), no community should be used as a weapon. Communities
                should create a sense of belonging for their members, not try to
                diminish it for others. Likewise, everyone on SocialSphere
                should have an expectation of privacy and safety, so please
                respect the privacy and safety of others.The rules governing
                each community are the platform-wide rules that apply to
                everyone on Reddit. These rules are enforced by the admins.
              </Text>
              <Stack
                spacing={4}
                divider={
              ...
              >
                <Feature
                  ...
                  text={"Developing Community Guidelines"}
                />
                <Feature
                  icon={
                  ...
                  text={"Enforcing Community Guidelines"}
                />
                <Feature
                  icon={
                    <Icon as={WarningTwoIcon} color={"red.500"} w={5} h={5} />
                  }
                  iconBg={useColorModeValue("red.100", "red.900")}
                  text={"Detecting violations"}
                />
                <Feature
                  icon={<Icon as={CheckIcon} color={"blue.500"} w={5} h={5} />}
                  iconBg={useColorModeValue("blue.100", "blue.900")}
                  text={"Allowing EDSA content"}
                />
                <Feature
                  icon={<Icon as={ViewIcon} color={"purple.500"} w={5} h={5} />}
                  iconBg={useColorModeValue("purple.100", "purple.900")}
                  text={"Taking action on violations"}
                />
              </Stack>
            </Stack>
            <Flex>
