      ...
      >
        <div className="flex justify-between items-center text-base gap-8">
          ...
          >
            ...
            <span className="text-brandPrimary" mr-0>Social</span>
            <span className="text-yellow400" mr-0>Sphere</span>
          </a>
          ...
          <div className="space-x-12 hidden lg:flex items-center">
            <a
              href="/"
              className="hidden lg:flex items-center text-brandPrimary hover:text-yellow400"
            >
              Login
            </a>
            <button className="bg-brandPrimary text-white  py-2 px-4 transition-all duration-300 rounded hover:bg-yellow400">
              Join Now
            </button>
          </div>
